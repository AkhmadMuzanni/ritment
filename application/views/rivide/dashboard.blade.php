...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/app-assets/vendors/css/charts/chartist.css">
    <link rel="stylesheet" type="text/css" href="assets/app-assets/vendors/css/charts/chartist-plugin-tooltip.css">
    <!-- END VENDOR CSS-->
    <!-- BEGIN CHAMELEON  CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="assets/app-assets/css/core/colors/palette-gradient.css">
    <link rel="stylesheet" type="text/css" href="assets/app-assets/css/pages/chat-application.css">
  ...
  <body class="vertical-layout vertical-menu 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu" data-color="bg-gradient-x-purple-blue" data-col="2-columns">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="assets/app-assets/images/backgrounds/02.jpg">
	...
	<div class="row match-height">
		<div class="col-xl-4 col-md-6">
			<div class="card">
				...
				<img class="img-fluid" src="assets/app-assets/images/carousel/22.jpg" alt="Card image cap">
				<div class="card-body">
				...
				<div id="carousel-area" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="carousel-item active">
							<img src="assets/app-assets/images/carousel/23.jpg" class="d-block w-100" alt="First slide">
						</div>
						<div class="carousel-item">
							<img src="assets/app-assets/images/carousel/22.jpg" class="d-block w-100" alt="Second slide">
						</div>
						<div class="carousel-item">
							<img src="assets/app-assets/images/carousel/24.jpg" class="d-block w-100" alt="Third slide">
						</div>
					</div>
...
<div class="col-md-8 col-sm-12">
    ...
    <script src="assets/app-assets/vendors/js/charts/chartist.min.js" type="text/javascript"></script>    
    ...
    <!-- END PAGE LEVEL JS-->
    <script src="assets/app-assets/js/scripts/charts/chartjs/pie-doughnut/doughnut-simple.js" type="text/javascript"></script>
  </body>
</html>