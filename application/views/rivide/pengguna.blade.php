    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow " data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
          <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="{{route('penduduk')}}"><i class="ft-layers"></i><span class="menu-title" data-i18n="">Data Penduduk</span></a>              
            </li>
            ...
            <li class=" nav-item active"><a href="{{route('pengguna')}}"><i class="ft-zap"></i><span class="menu-title" data-i18n="">Data Pengguna</span></a>           
            </li>
